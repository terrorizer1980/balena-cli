...
* Removes hardcoded path [ab77]
* Fix Windows installer build in new balena CI workers (qqjs patch) [Paulo Castro]
* empty [ab77]
* Fix 'balena ssh' test cases when using the Windows built-in ssh tool [Paulo Castro]
* empty [ab77]

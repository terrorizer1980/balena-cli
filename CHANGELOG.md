...
* Fix type error and refactor mergeDevComposeOverlay [Paulo Castro]
* Also check docker-compose.dev.yml service names [Josh Bowling]
* Harmonize --buildArg flag treatment between build/deploy/push commands [Paulo Castro]
* Add tests for `push --buildArgs` and refactor logic [Paulo Castro]
* Various review fixes [Josh Bowling]
* Add --buildArg support for push command [Josh Bowling]
